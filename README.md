...
This is a complete Diary program with save and security function. The program in this repository is set up with some showcase users all with the pwd:1234.
